...
public class InventorySystem {
     ...
     *
     * @throws IllegalArgumentException if the itemIdentifier is not valid
     * @throws RuntimeException if the server is not active
     */
    public static Item getItem(int itemIdentifier) throws IllegalArgumentException, RuntimeException {
        return switch (itemIdentifier) {
            ...
            case 4 -> throw new RuntimeException("The server is not active");
            default -> throw new IllegalArgumentException("Unknown item identifier: " + itemIdentifier);
        };
    }
